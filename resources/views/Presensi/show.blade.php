    ...
    <div class="col-lg-4">
        <div class="card h-100">
            <div class="card-body text-center py-4">
                ...
                <span class="badge bg-{{ $presensi->transaksi->anggota->status_badge }} mb-3">
                    {{ $presensi->transaksi->anggota->status_label }}
                </span>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="form-label text-muted mb-1">ID Transaksi (QR Code)</label>
                        <p class="fw-semibold mb-0">
                            <a href="{{ route('transaksi.show', $presensi->transaksi) }}">TRX-{{ $presensi->transaksi->id }}</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="user-avatar me-3" style="width: 48px; height: 48px; font-size: 1rem;">
                        {{ $presensi->transaksi->anggota->initials }}
                    </div>
                    <div>
                        <h5 class="mb-1">{{ $presensi->transaksi->anggota->nama }}</h5>
                        <p class="text-muted mb-0">{{ $presensi->transaksi->anggota->no_telp }}</p>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mb-3">
                        ...
                        <p class="fw-semibold mb-0">{{ $presensi->transaksi->anggota->jenis_kelamin_label }}</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label text-muted mb-1">Tanggal Daftar</label>
                        <p class="fw-semibold mb-0">{{ $presensi->transaksi->anggota->tanggal_daftar->format('d/m/Y') }}</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label text-muted mb-1">Status</label>
                        <p class="fw-semibold mb-0">
                            <span class="badge bg-{{ $presensi->transaksi->anggota->status_badge }}">
                                {{ $presensi->transaksi->anggota->status_label }}
                            </span>
                        </p>
                    </div>
                ...
                <div class="mt-3">
                    <a href="{{ route('anggota.show', $presensi->transaksi->anggota) }}" class="btn btn-light">
