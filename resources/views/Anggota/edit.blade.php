...
<div class="page-header">
    <div class="d-flex align-items-center mb-2">
        ...
        <h1 class="page-title mb-0">Edit Anggota</h1>
    </div>
    <p class="page-subtitle">Perbarui data anggota</p>
</div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_daftar') is-invalid @enderror" 
                           id="tanggal_daftar" name="tanggal_daftar" value="{{ old('tanggal_daftar', $anggota->tanggal_daftar ? $anggota->tanggal_daftar->format('Y-m-d') : date('Y-m-d')) }}">
